...
def postComments(comments_data)
	...
	while post_comments_length > 0 do
		...
		# 	html = html + " <div class=\"replies\" style=\"display: none\">"
		# 	comment_replys_length = post_comments[0]["replys_comments"].length
		# 	reply = 0
		...
		# 	end
		# else
		# 	html = html + " <div class=\"replies\" style=\"display: none\"><div class=\"commentForm media\"><img src=\"images/user.png\" class=\"profilePhoto\"> <div class=\"media__info\"><form action=\"javascript\" method=\"post\"><textarea name=\"comment\" class=\"commentBox\"></textarea><input type=\"submit\"></form></div></div>"
		# end
